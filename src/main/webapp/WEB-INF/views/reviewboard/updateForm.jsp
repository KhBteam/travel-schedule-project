...
<html lang="ko">
    ...
    <body>
        ...
        <form>
            <input type="text" class="review_1" placeholder="제목을 입력해주세요." name="title" id="title" value="${board.title}">
            <textarea cols="50" rows="10" class="review_2" placeholder="후기를 적어주세요." name="content" id="content">${board.content}</textarea>
            <input type="hidden" id="id" value="${board.id}"/>
            
        </form>
        
       <input type="button" id="btn-update" class="btn_review" value="등록하기">
